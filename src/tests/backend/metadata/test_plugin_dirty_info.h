...
using loot::PluginDirtyInfo;
using loot::Message;

TEST(PluginDirtyInfo, ConstructorsAndDataAccess) {
...
TEST(PluginDirtyInfo, MessageOutput) {
    Message message;
...
TEST(PluginDirtyInfo, YamlEmitter) {
    PluginDirtyInfo info;
...
TEST(PluginDirtyInfo, YamlEncode) {
    YAML::Node node;
    PluginDirtyInfo info;
...
TEST(PluginDirtyInfo, YamlDecode) {
    YAML::Node node;
    PluginDirtyInfo info;
